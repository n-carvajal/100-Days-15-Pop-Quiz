question_data = [
    ...
    {"category": "Entertainment: Board Games", "type": "boolean",
     ...
     "correct_answer": "False", "incorrect_answers": ["True"]},
    {"category": "Animals", "type": "boolean", "difficulty": "medium",
     "question": "'Kamea,' the Gilbertese Islander word for dog, is "
                 "derived from the English phrase 'Come here!'",
     "correct_answer": "True", "incorrect_answers": ["False"]},
    {"category": "Geography", "type": "boolean", "difficulty": "medium",
    ...
    {"category": "Entertainment: Video Games", "type": "boolean",
     "difficulty": "medium",
     "question": "In 'Team Fortress 2', the 'Bill's Hat' is a "
                 "reference to the game 'Dota 2'.",
     "correct_answer": "False", "incorrect_answers": ["True"]},
    {"category": "Science & Nature", "type": "boolean", "difficulty": "medium",
    ...
    {"category": "Entertainment: Japanese Anime & Manga", "type": "boolean",
     "difficulty": "medium",
     "question": "The anime Attack on Titan was directed by Tetsur' Araki, the same person "
                 "who directed the anime High-school of the Dead.",
     "correct_answer": "True", "incorrect_answers": ["False"]},
    ...
    {"category": "Entertainment: Video Games", "type": "boolean",
     "difficulty": "medium",
     "question": "The ADAM collectors in the Bioshock series are known as Little Sisters.",
     "correct_answer": "True", "incorrect_answers": ["False"]},
    {"category": "Entertainment: Board Games", "type": "boolean",
     "difficulty": "medium",
